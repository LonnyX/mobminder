...
C_XL.d['not bdate']			= { 0:' A valid date of anniversary date is dd-mm-yyyy',	
								1:' Le format correcte pour la date anniversaire du contrat est jj-mm-aaaa',	
								2:' Poprawny format daty urodzenia jest dd-mm-rrrr',				
								3:' Het juiste formaat voor de startdatum is dd-mm-jjjj',
								4:'Ein gültiges Format für das Geburtsdatum ist tt-mm-jjjj',	
								5:' Il formato corretto per la data di nascita è gg-mm-aaaa',	
								6:' El formato correcto para la fecha de inicio del contrato es dd-mm-aaaa', 
...
C_XL.d['token validate'] 	= { 0:'Verify',		1:'Vérifier',	2:'zweryfikować',	3:'Nacijferen',	4:'Überprüfen',	5:'Verificare',	6:'Verificar', 	7:'Verificar'	};
...
C_XL.d['identify me'] 	= { 0:'Check me in',		1:'Je m\'identifie',	2:'Zidentyfikować mnie',3:'In checken',			4:'Mich anmelden',		5:'Mi identifico',	6:'Me identifico', 		7:'Identifico-me'		};
...
C_XL.d['e-welcome'] 	= { 0:'Welcome.<br/>Please enter your e-mail.',				
							...
							6:'Bienvenido.<br/>Por favor introduzca su dirección e-mail.', 7:'Bem-vindo.<br/>Por favor, introduza o seu endereço de e-mail.' };
...
C_XL.d['fill mobile'] = { 0:'In order to proceed with you identification, please fill in your mobile number.',				
							...
							5:'Completi con il Suo numero di cellulare (completo di prefisso internazionale +39) e data di nascita.',	
							6:'Para acabar su identificación, por favor indique su número de móvil.', 7:'Por favor,	adicione o seu número de telemóvel e a sua data de nascimento.' };
...
C_XL.d['eresa identified more'] = { 0:'The following visitors are associated with your email:',				
							...
							4:'Bitte geben Sie Ihre Mobilnummer und Ihr Geburtsdatum ein.',	
							5:'Completi con il Suo numero di cellulare (completo di prefisso internazionale +39) e data di nascita.',	
							6:'Listado de las personas vinculadas a su e-mail.', 
...
C_XL.d['eresa register more'] = { 0:'Register one more person.',				
...
C_XL.d['eresa ident continue one'] = { 0:'Make or cancel an appointment',				
...
C_XL.d['e-choose who to book for'] = { 0:'you are appointed yet on ',				
...
C_XL.d['e- done ok'] 	= { 0:'Quit',	1:'Terminé',	2:'Porzucić',	3:'Klaar',		4:'Beenden',	5:'Terminato',	6:'acabado', 7:'Terminado'	};
...
1:'Indiquez une note si nécessaire. Votre rdv sera ensuite confirmé par le paiement.',
...
1:'Votre rdv sera confirmé par le paiement.',
...
C_XL.d['pay_amount'] = { 0:'Please pay the amount of :',
1:'Veuillez payer la somme de :',
2:'Proszę zapłacić kwotę :',
3:'Betaal de som van :',
4:'Bitte zahlen Sie die Summe von :',
5:'Si prega di pagare la somma di : ',
6:'Por favor, pague la suma de :',
7:'Por favor, pague a soma de :'};
