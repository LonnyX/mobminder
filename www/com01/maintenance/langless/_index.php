...
<!-- <body onload = "JavaScript:AutoRefresh(300000);">  <!-- This page will refresh every 5 minutes -->
<body>  <!-- This page will refresh every 5 minutes -->
...
<section id="maintenance" class="maintenance">  
    <div class="shade"></div>
	<h1 class="bold mobminder"><img src="../assets/imgs/icon-1.png" alt="mobminder logo"/>&nbsp;<span class="white">mob</span><span class="mob-txt-lime">minder</span></h1>
    <div class="message-box wide">
            <h2 class="mob-txt-gray_m centered airup air"><?= X('breakdown_title') ?></h2>
