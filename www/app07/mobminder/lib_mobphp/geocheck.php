...
class C_geofind {
	...
	function __construct($useragent, $userip, $nobot = true) {
		...
		//Geoplugin https://www.geoplugin.com/home/login.php credentials Username:Jonmob jonathan@mobminder.com - Password:J0n4th4ngeo - key=ba58496b756693ec
		if($file) {
			...
			switch($this->ccod) { // assign by country code
				...
				case 'BE': 
					$this->phoneregion = 32; // that pretty country has 2 languages
					switch($this->rcod) {
				...
				case 'DK': $this->phoneregion = 45; $this->language = 'en'; break; // Denmark
				
				default: $this->phoneregion = 32; $this->language = 'en';
			}
		}
		else {
