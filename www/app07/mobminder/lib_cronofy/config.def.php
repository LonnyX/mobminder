...
define('cronofydebug', true);                   //true = debug log in all cronofy classes 
                                                //(production=FALSE)

define('cronofymidnitecalledbybrowser', true);  //true = run midnite job from browser : log e-mail instead of sending 
                                                //(production=FALSE)
...
define('cronodevtest',true);                    //true = EventsInitialization calls localhost cronasync.php url! 
