...
//
//
	var classOnlyVerbose = false; //monitorEresa; // (defines which filter to apply) default: false (verbose for all classes)
	var activate = 'activate';
	var functionOnlyVerbose = false; // default: false (verbose for all functions)
	

//////////////////////////////////////////////////////////////////	
//DEV -preventBrowserBackButton
//////////////////////////////////////////////////////////////////
...
C_iCLIK.prototype = {
	...
	display: function(css, rowspan, tag) {
		...
		switch(tag) {
			...
			default: 
				return '<a'+id+style+clss+'>'+label+'</a>';
		}
	},
	activate: function() {
		this.elements.collect(this.eids);
...
C_iEDIT.prototype = {
	...
	cleanup: function(digits) { // used by this.changed() and by this.getpost()
		cleanedup = digits.replace(C_iEDIT.exclude.always,''); // covers a copy/paste operation, that does not loop via keypress, see // this same regexp is used after a copy/paste check, see (*ed01*)
		let pattern = false;
