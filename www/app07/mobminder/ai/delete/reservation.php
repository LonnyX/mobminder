...
//////////////////////////////////////////////////////////////////////////////////////////////
//
//      Moby  A I   A P I    /    D E L E T E     R E S E R V A T I O N 
//
//
...
//////////////////////////////////////////////////////////////////////  ??!! Attention : effacer une r�servation qui est en pre-booking ?
//
...
if($web) span('&ltdata&gt');
	...
	echo '#C_dS_reservation'.$nl.$dS_resa->addmeta_prebooking()->setstringtimeformat4AI($utc)->stream(false, '|', $fieldsR).$nl;
