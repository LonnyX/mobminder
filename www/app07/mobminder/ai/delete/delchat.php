...
//////////////////////////////////////////////////////////////////////
//
//       Moby  A I   A P I    /     D E L E T E      C H A T       C O M M A N D
//
...
///// stream
//
	echo '<data>'.$nl; // enclose the file content within the stream
	if($web) span('&ltdata&gt');		
echo '#C_dS_chat_thread'.$nl.$dS_chat_thread->stream().$nl;
echo $participants->setstringtimeformat4AI()->stream();
