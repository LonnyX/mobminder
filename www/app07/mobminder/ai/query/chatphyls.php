...
//////////////////////////////////////////////////////////////////////
//
//    Moby  A I   A P I     /     Q U E R Y     C H A T     P H Y L A C T E R I E S 
//
...
span('&ltdata&gt');
	...
	echo $dbAccess_chat_phylacteries->setstringtimeformat4AI()->stream(no_tracking);
...
if($web) span('&ltpars&gt');

	echo 'phylpace=5'.$nl; // (*lag01*)
	
if($web) span('&lt/pars&gt');
echo '</pars>';
