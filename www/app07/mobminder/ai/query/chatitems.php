...
//////////////////////////////////////////////////////////////////////
//
//    Moby  A I   A P I     /      Q U E R Y    C H A T    T H R E A D S    I T E M S 
//
...
// $p = new C_chat_peek($context->dS_login->id);  // will follow an independant path using chatdog (polling) or ()
...
if($web) span('&ltdata&gt');
		...
		echo $participants->setstringtimeformat4AI()->stream(no_alias);
