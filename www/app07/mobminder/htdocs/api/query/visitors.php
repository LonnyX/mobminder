...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//    A P I   /   Q U E R Y    V I S I T O R S
//
...
//
// http://be.mobminder.com/api/query/visitors.php?lgn=voxy&pwd=laura&kid=19102&web=1&mobile=5599&lname=hove
//
...
if($id||$lnm||$phn||$mob||$bth||$gnd||$eml) {
	...
	if($lnm) if($visis->count()) { // note that for the web app, this additional work is done at client side, see (*ac01*)
...
span('&ltdata&gt');
		...
		$vfields = C_api::fieldslist('C_dS_visitor',$context->dS_login->accessLevel);
