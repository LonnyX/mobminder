...
$positions['mobile'] = array_search('mobile', $headers);
...
foreach($lines as $x => $split) {
	...
	$mobile = $split[$positions['mobile']];  

	$query = 'update visitors set mobile = "'.$mobile.'" where groupid = '.$accountId.' and reference = "'.$reference.'" and mobile = "";';
