...
// framework
$html->pushScriptInclude('text/javascript', '../jquery/3.2.1.js');
...
$html->pushScriptInclude('text/javascript', '../jscripts/mbloxtest.js?baseline='.$BASELINEversion);


// start the client side
$html->pushJavaScript('new mblox_MOB()');
