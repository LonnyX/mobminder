...
//
	...
	$rescId = false;
	$verbose = 100;
	$accresources = new C_dbAccess_resources($accountId);
	
foreach($lines as $x => $split) {
		
		
		$rescId = $split[2]; $appnote = $split[3]; $datyIn = $split[4]; $datyOut = $split[5]; 
