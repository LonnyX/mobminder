...
//  HTML Headers 
//
$out .= h1('mobminder appointments generator from Mobikap export');
...
$ad_position = array_keys($headers, 'appdate'); 	$ad_position = $ad_position[0]; // date is originally in mobikap like 26-08-16 (dd-mm-yy)
...
foreach($lines as $x => $split) {
		...
		if(!$visiId) {
			...
			// we create a visitor based on the info given in the mobikap appointment (uncomment if needed)
