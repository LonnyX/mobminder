SELECT reservations.id AS id, cueIn, cueOut FROM reservations JOIN attendees ON attendees.groupId = reservations.id WHERE cueOut >  AND cueIn < 86400 AND reservations.groupId = 3952 AND resourceId IN (11941);#!/bin/bash
