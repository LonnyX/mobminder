...
{ 		// read from DB
	...
	if(!$test) {
		...
		from logins 
			...
			where logins.profession = 201  -- GP
...
<tr>
	<td style="padding-left:2.5em; padding-right:2.5em;">
        ...
        <ul style="padding-left:1em; margin-block-start:0.2em; color:'.$txtcolormail.'; font-size:16px;">
			...
			<li style="margin-bottom:0.5em;">Support/assistance premium inclus</li>			
...
<tr>
	<td valign="middle" style="padding-left:2.5em; padding-right:2.5em; padding-top:20px; padding-bottom:20px; text-align: center;">
		<a rel="noopener" target="_blank" href="https://www.medinect.net/les-metiers/generaliste/" style="background-color:'.$buttoncolor.'; font-size: 18px; font-weight: bold; text-decoration: none; padding: 14px 20px; color: white; border-radius: 5px; display: inline-block;">
