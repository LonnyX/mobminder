...
class C_email {
	...
	public function subject() { return 'Mobminder - Nous avons besoin de vous!'; }
	...
	public function html() {
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:transparent; color:#404040; font-family:Arial; font-size:14px; line-height:150%;">
			<tr>
				<td colspan=2 valign="top" style="text-align:left; padding-left:2em; padding-right:2em; padding-top:0em; padding-bottom:0em;">
					<p style="color:#5D98EF; font-size:1.2em; text-align:center; padding-top:1em; padding-bottom:0em;">
					'.$this->dear.', vous êtes de retour de vacances<br/> ...et vous avez bonne mine!
					</p>
				</td>			
			</tr>
		</table>';
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:transparent; color:#404040; font-family:Arial; font-size:14px; line-height:150%;">
			<tr>
				<td valign="top" style="text-align:right;">
					<div style="text-align:center; overflow:hidden;">'.$selfiers.'</div>
				</td>
			</tr>
		</table>';
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:transparent; color:#404040; font-family:Arial; font-size:14px; line-height:150%;">
			<tr>
				<td colspan=2 valign="top" style="text-align:left; padding-left:2em; padding-right:2em; padding-top:0em;">
					<p>Votre avis est important et nous aimerions le partager d\'une manière moderne :)</p>
					<p style="color:#5D98EF; font-size:1.2em; text-align:center; padding-top:1em; padding-bottom:1em;">
					Nous aurions besoin d\'un petit coup de pouce de votre part!
					</p>
					<p> Auriez-vous la gentillesse de réaliser une petite vidéo-selfie avec votre smartphone? Puis de nous l\'envoyer?<br/></p>
				<ul>
					<li>Cela vous prendra une minute pour l\'imaginer et la réaliser.</li>
					<li>Il n\'y a pas de consignes. Soyez naturel et formulez votre ressenti en 15 secondes. Expliquez-nous là où Mobminder vous aide le plus! Depuis quand, comment, ...</li>
				</ul>
				</td>			
			</tr>
		</table>';
		...
		<tr>
			<td valign="bottom" style="text-align:left; padding-left:2em; padding-right:0em; padding-top:0em;">
				<p style="margin:0">Si vous avez tout de-même envie de vous baser sur un modèle, voici ce que votre vidéo pourrait raconter:</p>
				<ul>
					<li style="margin-top:1em;">"Bonjour, je suis le dentiste Bertrand, de Namur, j\'utilise Mobminder depuis 2011 et j\'en suis très satisfait. Mais ce sont surtout mes patients qui en profitent. Les SMS de rappel améliorent notre relation, et ils aiment prendre RDV via ma page Web, à toute heure du jour ou de la nuit."</li>
					<li style="margin-top:1em;">"Bonjour, je suis le Dr Vincent.  J\'utilise Mobminder depuis 2015. Mobminder est également ma passerelle avec le télésecrétariat qui s\'occupe d\'organiser mon emploi du temps pendant que je m\'occupe de mes patients!"</li>
					<li style="margin-top:1em;">"Bonjour, je suis Martine, gestionnaire de planning à la Clinique du Soleil de Woluwe. Je connais Mobminder depuis 2010. J\'apprécie spécialement leurs efforts pour répondre rapidement à mes questions quand il y a un changement de configuration dans nos plannings. Les médecins utilisent chacun leur agenda que nous nous occupons d\'organiser."</li>
					<li style="margin-top:1em;">"Bonjour, je suis Nathalie, responsable d\'un centre d\'esthétique à Paris. Mobminder nous permet quotidiennement de partager nos locaux et équipements entre professionnels, c\'est un outil puissant qui communique à plusieurs reprise avec nos clients, par email et par SMS. Parfait pour les plus grosses structures!"</li>
				</ul>
			</td>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:transparent; color:#404040; font-family:Arial; font-size:14px; line-height:150%;">
			<tr>
				<td colspan=2 valign="top" style="text-align:left; padding-left:2em; padding-right:2em; padding-top:0em;">
					<p style="margin:0; margin-top:1em;">A la fin de la vidéo, vous pouvez également laisser une attention envers l\'équipe Mobminder ou bien nous conseiller aux visiteurs du site www.mobminder.com.</p>
					<p style="color:#5D98EF; font-size:1.2em; text-align:center; padding-top:1em; padding-bottom:1em;">
					Une fois ce selfie envoyé, vous recevez une bouteille de champagne !
					</p>
				</td>			
			</tr>
		</table>';
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:transparent; color:#404040; font-family:Arial; font-size:14px; line-height:150%;">
			<tr>
				<td colspan=2 valign="top" style="text-align:left; padding-left:2em; padding-right:2em; padding-top:0em;">
					<p style="margin:0; margin-top:1em;">Voici comment partager votre vidéo avec nous:</p>
					<ul>
						<li>A partir d\'un iPhone, faites un envoi iMsg  vers le numéro 0483 37 11 60.</li>
						<li>A partir d\'un Androïd, faites un envoi via Whatsapp, en haute qualité, sur le numéro 0483 37 11 60</li>
						<li>Depuis le pc, utilisez gratuitement wetransfer.com et expédiez svp sur  communication@mobminder.com</li>
						<li>Ca ne marche pas? Contactez votre contact Mobminder ou notre support au 02 880 97 87</li>
					</ul>
					<p style="margin:0; margin-top:1em;">Encore un tout grand merci pour votre collaboration!</p>
					<p style="margin:0; margin-top:1em;">L’équipe Mobminder.</p>
