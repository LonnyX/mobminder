...
class C_email {
	...
	public function subject() { return 'Merci d\'avoir parlé de nous autour de vous!';}
	...
	public function html() {
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:transparent; color:#404040; font-family:Arial; font-size:14px; line-height:150%;">
			<tr>
				<td valign="top" style="text-align:right;">
					<div style="text-align:center; overflow:hidden;">'.$duet.'</div>
				</td>
			</tr>
		</table>';
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:transparent; color:#404040; font-family:Arial; font-size:14px; line-height:150%;">
		<tr>
			<td valign="top" style="color:#7DB8EF; font-size:1.6em; text-align:center; padding-top:1em; padding-bottom:1em;">
				<strong>Merci d\'avoir parlé de nous !</strong>
			</td>
		</tr>
		</table>';
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:transparent; color:#404040; font-family:Arial; font-size:14px; line-height:150%;">
			<tr>
				<td colspan=2 valign="top" style="text-align:left; padding-left:2em; padding-right:2em; padding-top:0em;">
					<p>Vous recevez cet email parce que vous êtes un utilisateur satisfait de Mobminder. Vous êtes nombreux à nous référencer auprès de votre cercle professionnel.</p>
					<p>Nous souhaitons vous remercier! Notre équipe à prévu des avantages uniques pour chaque personne que vous référencez, mais aussi pour vous même;</br></p>
					<p style="font-size:1.2em; text-align:center; padding-top:1em; padding-bottom:1em;">Comment fonctionne cette action de parrainage?</p>
				</td>			
			</tr>
		</table>';
		...
		<tr>
			<td valign="top" style="text-align:left; padding-left:2em; padding-right:0em; padding-top:0em;">
				<p style="margin:0">Lors du rendez-vous de présentation avec notre délégué, votre contact précise qu’il a connu Mobminder grâce à vous, déjà utilisateur Mobminder.</br></p>
				<p style="font-size:1.2em; text-align:center; padding-top:.5em; padding-bottom:.5em;">Quels avantages pour le parrain</br>et pour le parrainé?</p>
				<p>Grâce à l\'excellente collaboration avec nos partenaires, Mobminder vous permet de bénéficier au choix d\'un de ces 2 services :</br></p>
				<ul>
					<li>Secrétariat médical gratuit pendant 1 mois.  En déviant votre ligne téléphonique vers l’un de nos secrétariats partenaires. Une équipe de secrétaires se chargera de réceptionner vos appels selon vos consignes. Recevez un mois gratuit sans frais ni engagement afin de mesurer les avantages et la facilité de ce service.</br>&nbsp;</li>
					<li>Site Web professionnel et référencement Google gratuit pendant 1 an. Offrez une meilleure visibilité à votre établissement avec 1 site internet personnalisé.  2 clics suffiront à vos '.$this->alias.' pour vous retrouver. 100% gratuit durant 1an.</li>
				</ul>
			</td>
			<td valign="top" style="text-align:right;">
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:transparent; color:#404040; font-family:Arial; font-size:14px; line-height:150%;">
			<tr>
				<td colspan=2 valign="top" style="text-align:left; padding-left:2em; padding-right:2em; padding-top:0em;">
				<p>Vous souhaitez bénéficier de cette offre? Parlez-en autour de vous et recevez votre cadeau dès l\'adhésion du parrainé.</p>
				<p>Encore merci pour votre confiance!</p>
				<p style="font-size:0.9em; padding-top:1em;">* Les parrainages à l\'intérieur d\'un même cabinet ne sont pas éligibles</p>
				<p style="font-size:0.9em; padding-top:1em;">** Si vous êtes déjà client du secrétariat médical, vous ne pouvez pas pas choisir l\'option secrétariat médical</p>
				</td>			
			</tr>
		</table>';
