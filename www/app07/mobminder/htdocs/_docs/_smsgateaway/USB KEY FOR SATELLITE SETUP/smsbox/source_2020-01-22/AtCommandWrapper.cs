...
namespace SmsBox
{
    public class AtCommandWrapper
    {
        ...
        public bool SendSmsPdu(string numero, string msgsource, bool echoon, out bool sentwithsuccess, int groupeindex, int nbpart, int currentpart, SMS.SMSEncoding pduformat)
        {
            SMS sms = new SMS();
