...
namespace SmsBox
{
    public class CustomWebRequest : IDisposable
    {
        ...
        public HttpWebResponse _myHttpWebResponse = null;
        ...
        public CustomWebRequest(string URL, int timeoutms_)
        {
            _URL = URL;
        ...
        public void PostData()
        {
            ...
            myRequest = (HttpWebRequest)WebRequest.Create(urlUri);
            myRequest.KeepAlive = true;
            myRequest.CookieContainer = cookies;
            myRequest.Timeout = timeoutms;
            myRequest.ReadWriteTimeout = timeoutms;
            //myRequest.
                    ...
                    case ParamType.File:
                        {
                            ...
                            if (auxSt != null)
                            {
                                ...
                                StreamReader sr = new StreamReader(auxSt, Encoding.GetEncoding("ISO-8859-1"));
                                retVal = sr.ReadToEnd();
                            }
                            else
