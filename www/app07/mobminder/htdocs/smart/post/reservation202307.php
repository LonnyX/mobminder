...
//////////////////////////////////////////////////////////////////////////////////////////////
//
//         S M A R T   A P I   /   P O S T    R E S E R V A T I O N 
//
//
	...
	if($isanewresa) { 
		...
		h3('Optional fields');
			...
			h3('Checking for mandatory fields');
				...
				indent('o reservation id :'.$resaId.' is valid '.($archived?'(archived)':'(live)'),6);
...
if($abortnotifications) warning('No notification will be sent: '.$abortnotifications);
	...
	sendEventMessages($context->dS_login, $dS_account, $resaId, action_create+action_change, $timing_changed, $testmode = local_test);
