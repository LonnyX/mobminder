...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//    S M A R T    A P P     A P I   /   P O S T     C H A T      T H R E A D 
//
//              
//
...
// $dS_chat_thread->deletor = ""; // PVH2025 this allows to pass ->deletor on the .php interface... it was a error.
...
if($dbAccess_chat_participants_tobe->hasLoginId($lid)) { // if the surfer excludes himself from a chat, his browser doesn't get any feedback dSets
	...
	span('&ltdata&gt');
		...
		echo $dbAccess_chat_participants_tobe->setstringtimeformat()->stream(no_alias, no_bank, with_tracking);
