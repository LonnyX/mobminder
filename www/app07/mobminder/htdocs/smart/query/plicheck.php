...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//    S M A R T     A P I   /   C H E C K    P L A N N I N G    I T E M S
//
...
span('&ltpars&gt');
	...
	echo 'plilag=30'.$nl; 								// rythm for calling this script
	echo 'cfvr='.$context->dS_account->cfgversion.$nl; 	// account config version, see (*cv01*)
	echo 'apvr=1.0.34'.$nl;								// AppStore and PlayStore version number
