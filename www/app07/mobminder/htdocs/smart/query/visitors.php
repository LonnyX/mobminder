...
if($vqcount)
	foreach($visis->keyed as $vid => $dS_visitor) { // PVH 2025-01 : preserve the older versions of the smartapp from the new language_code_luxembourgish and gender_code_other
