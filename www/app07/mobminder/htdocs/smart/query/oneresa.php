...
////////////////////////////////////////////////////////////////////////////////////////////////////////
//
//    S M A R T   A P P   A P I   /   Q U E R Y    O N E   R E S E R V A T I O N
//
//
...
span('&ltdata&gt');
	...
	echo '#C_dS_reservation'.$nl.$dS_resa->addmeta_prebooking()->setstringtimeformat($utc)->stream(no_tracking, $sep = '|', $flds = $fieldsR).$nl;
